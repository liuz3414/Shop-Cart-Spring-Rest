...
public class StartupData implements CommandLineRunner {
    ...
    public void run(String... args) {
    	System.out.print("Start inserting data here...\n");
        adminAccount();
        userAccount();
        category();
        exampleProducts();
    ...
    private void exampleProducts(){
        final String NAME1 = "New Product1";
        final String NAME2 = "New Product2";
        final String NAME3 = "New Product3";
        final String NAME4 = "New Product4";
